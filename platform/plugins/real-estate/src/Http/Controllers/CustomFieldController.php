...
class CustomFieldController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/real-estate::custom-fields.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/real-estate::custom-fields.create'));
    ...
    public function edit(int|string $id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/real-estate::custom-fields.edit', ['name' => $customField->name]));
